...
`),
  ...
  let I = {},
    ...
    H = () => {
      ...
      BABYLON.SceneLoader.ImportMesh("", "./", "Mannequin.glb", h, (e) => {
        (r = new BABYLON.TransformNode("mannequinRoot", h)),
          e.forEach((e) => {
          ...
          (r.parent = _),
          (r.scaling = new BABYLON.Vector3(0.01, 0.01, 0.01)),
  ...
  function q(e) {
    ...
    r.setKeys(c), l.setKeys(d), o.setKeys(p);
...
`;
  ...
  function W() {
    if (void 0 === l || void 0 === o || void 0 === c || void 0 === d) {
      ...
      `;
        ...
        window.matchMedia("(max-width: 1024.9px)").matches &&
          (function e() {
            ...
            let l = document.getElementById("colorChoices");
            if (l) {
              let o = l.querySelectorAll(".color-option");
              o.forEach((e) => {
  ...
  function er(e, t, a, s) {
    ...
    (r.className = "cards-wrapper"),
      s.forEach((t, s) => {
        let n = (function e(t, a, s, n) {
          let i = n.replace("/fabric_optimized/", "/fabric_optimized_2048/"),
            r = document.createElement("div");
          (r.className = "card_cardContainer card_small"),
            (r.dataset.testId = s),
            (r.tabIndex = s + 1),
            r.setAttribute("data-original-url", n + a);
  ...
  function el(e) {
    ...
    let s = p[e];
    if (Array.isArray(s))
      er(e, null, "./assets/fabric_optimized/All Fabrics/", s);
    else {
      let n;
      if (
        window.matchMedia("(max-width: 1024.9px)").matches &&
      ...
      Object.keys(s).forEach((t, a) => {
        let i = s[t],
          r = (function e(t, a, s, n) {
            ...
            let l = `./assets/fabric_optimized/${t}/${a}/`,
              o = l.replace("/fabric_optimized/", "/fabric_optimized_2048/"),
              c = s.slice(0, 4);
            c.forEach((e) => {
      ...
      Object.keys(p).forEach((e, a) => {
        let s = (function e(t, a) {
          ...
          let i = [],
            r = 0,
            l = p[t];
          if (Array.isArray(l)) (i = l.slice(0, 4)), (r = l.length);
          else {
            let o = Object.keys(l);
            o.length > 0 && ((i = l[o[0]].slice(0, 4)), (r = l[o[0]].length));
          }
          let c = "";
          c =
            "All Fabrics" === t
  ...
  function em(e) {
    ...
    if (t) {
      ...
      l.style.maxHeight && "0px" !== l.style.maxHeight
  ...
  function eh(e) {
    ...
    if ("top" === e) {
      ...
      let r = t.filter((e) => eg.includes(e.meshName));
      r.forEach((e) => {
        let t = document.createElement("div");
        (t.className = "part-option card_cardContainer"),
          t.setAttribute("data-part-name", "Pockets"),
      ...
      if ("top" === a) {
        ...
        r
          ? (r.setEnabled(!0),
            ...
            C.addMesh(r, BABYLON.Color3.White()))
          : console.warn(
  ...
  function eb(e) {
    ...
    r && "none" !== r.style.display && (ef(), (r.style.display = "block"));
  }
  function e6(e, t) {
    ...
    for (
      ...
      (_ = e[b]),
        ($ = (l[b] / 100) * r[b]),
        (h = (g = _.offsetLeft + $ - n) + r[b] * gsap.getProperty(_, "scaleX")),
        a
          .to(_, { xPercent: d((($ - h) / r[b]) * 100), duration: h / c }, 0)
          .fromTo(
            _,
            { xPercent: d((($ - h + u) / r[b]) * 100) },
            {
              xPercent: l[b],
              duration: ($ - h + u - $) / c,
              immediateRender: !1,
  ...
  document.getElementById("backButton").addEventListener("click", function () {
    W(),
      ...
      m > 1 &&
        ...
        ee(m),
        ev()),
      gsap.to(".canvas-container", { duration: 0.5, autoAlpha: 1 }),
    ...
    document
      ...
      .addEventListener("click", function () {
        ...
        if (1 === m) {
          ...
          (function e() {
            if (!u.currentMeasurementType) return !1;
            let t = [];
            for (let a of ("pants" === u.currentMeasurementType
              ? (t = [
                  "pantLengthInput",
                  "waistInput",
                  "hipsInput",
              ...
              : "blazer" === u.currentMeasurementType &&
                (t = [
                  "bodyTypeSelect",
                  "frontLengthInput",
                  "backLengthInput",
            ...
            t)) {
              let s = u.measurements[a];
              if ("bodyTypeSelect" === a) {
                if (!s || "" === s.trim()) return !1;
              } else if (!s || 0 >= parseFloat(s)) return !1;
            }
            return !0;
          })()
            ? ee(++m)
